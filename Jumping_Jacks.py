...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # Simple threshold for arms raised
            arm_angle = calculate_angle(shoulder, wrist, [wrist[0], wrist[1] - 0.1])

            if arm_angle > 160 and not jumping_jack_detected:
                print("Jumping jack detected")
                jumping_jack_detected = True
            ...
            cv2.putText(image, f'Jumping Jacks: {jumping_jack_counter}',
